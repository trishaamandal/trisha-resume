...
\begin{itemize}
    \item \textbf{\href{https://github.com/Arkapravo-Ghosh/UIC-Project}{Smart Parking System:}} {Built an Open Source Parking System that updates status of parking slot availability in realtime using Python, Raspberry Pi or Arduino Uno, and SQL.}
